...
<div class="header"><img src="images/logo.png" style="height:50px;margin-bottom:4px" alt="LagunaDubai"><div style="font-size:14px;font-weight:700;margin-bottom:4px">LagunaDubai</div><h2>** فاتورة كاشير **</h2><p>${dateStr}</p><p>${inv.customer}${inv.table ? ' | ' + inv.table : ''}</p><p style="font-size:10px">#${inv.id}</p></div>
