window.TEMPLATE = (() => {
  ...
  function defaultCashierTemplate() {
    return '<div style="width:300px;margin:0 auto;font-family:\'Cairo\',sans-serif;direction:rtl;background:#fff;padding:10px 8px;color:#222;">\n'
      + '  <div style="text-align:center;margin-bottom:6px;">\n'
      + '    {logo}\n'
      + '    <div style="font-size:16px;font-weight:800;">لاجونا دبي</div>\n'
      + '    <div style="font-size:10px;color:#888;">كافيه - مطعم</div>\n'
      + '  </div>\n'
      + '  <div style="border-top:2px solid #222;margin:4px 0;"></div>\n'
      + '  <table style="width:100%;font-size:11px;line-height:1.8;margin:4px 0;">\n'
      + '    <tr><td style="color:#888;">رقم الفاتورة</td><td style="text-align:left;font-weight:700;">#{id}</td></tr>\n'
      ...
      + '    <tr style="border-bottom:2px solid #222;font-weight:700;">\n'
      + '      <td style="padding:3px 2px;">الصنف</td>\n'
      + '      <td style="width:30px;text-align:center;">الكمية</td>\n'
      + '      <td style="width:40px;text-align:center;">السعر</td>\n'
      + '      <td style="width:45px;text-align:left;">الإجمالي</td>\n'
      + '    </tr>\n'
      + '    {items}\n'
      + '    <tr style="border-bottom:1px dotted #ccc;">\n'
      + '      <td style="padding:4px 2px;font-size:12px;">{name}</td>\n'
      + '      <td style="text-align:center;font-size:12px;">{qty}</td>\n'
      + '      <td style="text-align:center;font-size:12px;">{price}</td>\n'
      + '      <td style="text-align:left;font-size:12px;font-weight:700;">{total}</td>\n'
      + '    </tr>\n'
      + '    {/items}\n'
      + '  </table>\n'
      + '  <div style="border-top:1px dashed #aaa;margin:4px 0;"></div>\n'
      + '  <table style="width:100%;font-size:12px;line-height:2;">\n'
      + '    <tr><td style="color:#888;">الإجمالي الفرعي</td><td style="text-align:left;">{subtotal}</td></tr>\n'
      + '    {taxAmount}\n'
      + '    {serviceAmount}\n'
      + '  </table>\n'
      + '  <div style="background:#222;color:#fff;border-radius:6px;padding:8px 12px;margin:6px 0;display:flex;justify-content:space-between;align-items:center;">\n'
      + '    <span style="font-size:13px;">الإجمالي الكلي</span>\n'
      ...
      + '    <tr><td style="color:#888;">المتبقي</td><td style="text-align:left;color:#c0392b;">{remaining}</td></tr>\n'
      + '  </table>\n'
      + '  <div style="border-top:2px solid #222;margin:6px 0 4px;"></div>\n'
      + '  <div style="text-align:center;font-size:10px;color:#888;">شكراً لزيارتكم</div>\n'
      + '  <div style="text-align:center;font-size:10px;color:#888;margin-top:2px;">{footer}</div>\n'
      + '  <script>window.print();window.close();<\/script>\n'
      + '</div>';
  }

  function defaultKitchenTemplate() {
    return '<div style="width:300px;margin:0 auto;font-family:\'Cairo\',sans-serif;direction:rtl;background:#fff;padding:12px 10px;color:#222;">\n'
      + '  <!-- Header -->\n'
      + '  <div style="text-align:center;margin-bottom:6px;">\n'
      + '    <div style="font-size:22px;font-weight:800;">أمر مطبخ</div>\n'
      + '    <div style="font-size:10px;color:#888;">لاجونا دبي - كافيه ومطعم</div>\n'
      + '  </div>\n'
      + '  <div style="border-top:3px solid #c0392b;margin:6px 0;"></div>\n'
      + '  \n'
      + '  <!-- Order info -->\n'
      + '  <table style="width:100%;font-size:13px;line-height:2;font-weight:700;">\n'
      + '    <tr><td style="color:#888;">طاولة</td><td style="text-align:left;font-size:16px;">{table}</td></tr>\n'
      + '    <tr><td style="color:#888;">رقم الطلب</td><td style="text-align:left;">#{id}</td></tr>\n'
      ...
      + '  {/items}\n'
      + '  \n'
      + '  <div style="border-top:2px solid #c0392b;margin:12px 0 4px;"></div>\n'
